...
export type Mob =
  (typeof mobsData)[number]

export type Block =
  (typeof blocksData)[number]

export type Item =
  (typeof itemsData)[number]
...
export const searchIndex: SearchEntry[] = [
  ...
  ...mobs.map((m) => ({
    ...
    editions: m.editions as Edition[]
  })),
  ...
  ...blocks.map((b) => ({
    ...
    href: `/blocks/${b.slug}`,
    meta: b.category,
    editions: b.editions as Edition[]
  })),
  ...
  ...items.map((i) => ({
    ...
    href: `/items/${i.slug}`,
    meta: i.category,
    editions: i.editions as Edition[]
  })),
